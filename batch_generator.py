...
def main():
    ...
    parser.add_argument("-o", "--output", default="batch_scenes", help="输出目录（默认：batch_scenes）")
    parser.add_argument("--example", action="store_true", help="生成示例批量配置文件")
    parser.add_argument("--example-output", default="batch_config_example.json", 
                       help="示例配置文件输出路径（默认：batch_config_example.json）")
